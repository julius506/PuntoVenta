...
public class DBTableModel extends AbstractTableModel   {
    ...
    public DBTableModel(String sql, String nombreConexion, String username, String password) {
        try {
            //Se abre la conexion utilizando el driver de postgres
            Class.forName("org.postgresql.Driver");
            conexion = DriverManager.getConnection(nombreConexion, username, password);
    ...
    public void actualizar(String sql, String nombreConexion, String username, String password)throws SQLException, IllegalStateException {
        this.desconectar();
